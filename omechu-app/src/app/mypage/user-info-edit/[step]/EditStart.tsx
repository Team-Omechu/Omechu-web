    ...
    <>
      ...
      <main className="flex min-h-[calc(100vh-3.1rem)] w-full flex-col items-center overflow-y-scroll overscroll-none scroll-smooth px-4">
        <section className="mb-28 mt-36 flex flex-col gap-5 text-center">
          ...
          <span className="whitespace-pre font-normal text-grey-normalActive">
            기본정보를 저장하여 {"\n"} 더 정교한 메뉴 추천을 받아보세요!
          </span>
        ...
        <section>
          <button
            ...
            className="flex h-16 w-48 items-center justify-center rounded-md bg-primary-normal p-5 text-2xl font-medium text-white hover:bg-primary-normalHover active:bg-primary-normalActive"
          >
            시작하기
          </button>
        </section>
