    ...
    <main className="relative flex flex-col items-center overflow-y-auto px-4 py-32 scrollbar-hide">
      ...
      <section className="mt-28">
        <button
          ...
          className={`h-12 w-[335px] rounded-md text-lg font-medium text-white hover:bg-secondary-normalHover active:bg-secondary-normalHover ${isValid ? "bg-primary-normal" : "cursor-not-allowed bg-grey-normal"}`}
        >
          {isLoading ? "저장 중..." : "저장"}
        </button>
