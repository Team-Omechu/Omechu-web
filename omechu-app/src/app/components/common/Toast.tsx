...
export default function Toast({ message, show, className }: ToastProps) {
  ...
  return (
    ...
    >
      <div
        className={`flex h-16 w-auto items-center justify-center rounded-xl bg-grey-normal-active px-5 py-3 text-center text-sm text-white shadow-lg backdrop-blur-xs transition-opacity duration-300 ${isHiding ? "opacity-0" : "animate-shake opacity-50"} `}
      >
