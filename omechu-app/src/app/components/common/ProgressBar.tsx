      ...
      {onCancelClick && (
        <div className={`flex ${alignClass}`}>
          <button
            ...
            className={`h-6.5 mt-2 w-auto rounded-md bg-[#00A3FF] px-2.5 pb-1.5 pt-2 text-xs font-light text-white hover:bg-[#1c8cc4] active:bg-[#197cae] ${cancelButtonClassName}`}
          >
            {cancelButtonText}
          </button>
        </div>
