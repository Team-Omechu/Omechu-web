...
const Header = ({ title, leftChild, rightChild, className }: HeaderProps) => {
  return (
    <header
      className={`border-grey-darkHoverActive relative z-10 flex min-h-[49px] w-full items-center border-b bg-main-normal px-5 py-2.5 text-[#393939] hover:bg-main-normalHover ${className}`}
    >
