...
const Header = ({ title, leftChild, rightChild, className }: HeaderProps) => {
  return (
    <header
      className={`relative z-10 flex min-h-[49px] w-full items-center border-b border-[#828282] bg-main-normal px-5 py-2.5 text-black hover:bg-main-normalHover dark:bg-[#baa0bf] dark:text-white dark:hover:bg-[#958099] ${className}`}
    >
