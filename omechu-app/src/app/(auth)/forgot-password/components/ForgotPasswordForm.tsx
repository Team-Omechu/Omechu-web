...
// 새 위치: src/app/(routes)/(auth)/forgot-password/components/ForgotPasswordForm.tsx
...
export default function ForgotPasswordForm({
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-1 pt-1 text-sm text-grey-normal-active">
        <div className="flex items-center justify-center gap-4">
          <span>비밀번호가 생각났어요</span>
          <Link
            href="/sign-in"
            className="font-semibold text-grey-dark-active hover:underline"
          >
            로그인 하기
          </Link>
        </div>
