...
export default function LocationModal({
  ...
  return (
    <div className="flex items-end justify-center pt-2">
      <div className="h-62 w-screen shrink-0 rounded-t-[1.25rem] border-t border-t-grey-dark-hover bg-[#FFFEFD] p-4">
        ...
        {distances.map(({ label, value }) => (
          <div key={value} className="flex items-center py-3">
            ...
            >
              <span
                className={`h-4 w-4 rounded-full border border-grey-dark-hover ${selected === value ? "bg-red-500" : "bg-white"}`}
              />
