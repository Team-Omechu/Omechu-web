...
export default function MainPage() {
  ...
  return (
    <div className="relative flex h-[calc(100dvh-5rem)] w-full justify-center overflow-hidden scrollbar-hide bg-gradient-to-b from-pink-200 to-purple-300">
      {/* 데스크톱용 컨테이너 */}
      <div className="relative w-full max-w-md mx-auto lg:max-w-lg xl:max-w-xl">
        ...
        <div className="absolute bottom-6 left-1/2 flex -translate-x-1/2 transform gap-4 lg:bottom-8">
          <button
            className="flex h-[2.8125rem] w-[9.0625rem] flex-shrink-0 items-center justify-center gap-[0.625rem] rounded-[0.375rem] bg-primary-normal p-[1.25rem] text-center text-white hover:bg-opacity-90 transition-all duration-200 lg:h-12 lg:w-40"
            onClick={handleStartClick}
          >
            <span>시작하기</span>
          </button>
          <button
            className="flex h-[2.8125rem] w-[9.0625rem] flex-shrink-0 items-center justify-center gap-[0.625rem] rounded-[0.375rem] border border-[#00A3FF] bg-[#FFF] p-[1.25rem] text-center text-[#00A3FF] hover:bg-secondary-lightHover hover:text-white active:bg-secondary-lightActive active:text-white transition-all duration-200 lg:h-12 lg:w-40"
